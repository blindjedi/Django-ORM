"""
Django settings for django_orm_practice project.
...
SECRET_KEY = 'django-insecure-pijajm*8=1agxixz+&k#4!&nmo=o(n7-pdm8^_n!4s2bbg^a+l'
...
ROOT_URLCONF = 'django_orm_practice.urls'
